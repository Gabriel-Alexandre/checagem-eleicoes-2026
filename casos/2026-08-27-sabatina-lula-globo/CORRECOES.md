...
| 11/set/2026 | **este registro**, linha do `A011` · quem pegou o erro | "Quem pegou foi a revisão humana." | **Quem pegou foi uma segunda leitura da própria IA**, depois de o validador reprovar os outros itens desta tabela | O registro da sessão de 06/set mostra que, entre o pedido e a descoberta, **nenhuma pessoa tinha lido a checagem**. A frase soava certa e foi escrita sem conferir, que é o mesmo defeito do "desde 1986". Achado ao preparar um vídeo sobre o projeto. ⚠️ Não muda veredito nem fonte. E reforça a limitação, em vez de enfraquecer: a leitura que pegou este erro é da mesma IA que o escreveu, e nada garante que ela pegue o próximo. Por isso a revisão humana continua obrigatória antes de publicar (`ESTADO.md`, item 2). |
